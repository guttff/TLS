...
```mermaid
graph LR
Florida-->Paris[Paris ~9h]
Florida-->Rome[Rome ~10h]
Florida-->Tokyo[Tokyo ~17h]
Florida-->Bali[Bali ~22h]
Florida-->Caribbean[Caribbean ~2h]
Florida-->Brazil[Brazil ~8h]
```
...
```mermaid
graph LR
EarlyBooking-->LowPrices
MidBooking-->MediumPrices
LateBooking-->HighPrices
```
